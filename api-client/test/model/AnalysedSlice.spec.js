...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new InteractiveSpectralExploration.AnalysedSlice();
  });
  ...
  describe('AnalysedSlice', function() {
    it('should create an instance of AnalysedSlice', function() {
      // uncomment below and update the code to test AnalysedSlice
      //var instane = new InteractiveSpectralExploration.AnalysedSlice();
      //expect(instance).to.be.a(InteractiveSpectralExploration.AnalysedSlice);
    });
