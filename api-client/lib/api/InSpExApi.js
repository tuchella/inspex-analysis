...
var InSpExApi = function () {
  ...
  */
  function InSpExApi(apiClient) {
    _classCallCheck(this, InSpExApi);
  ...
  _createClass(InSpExApi, [{
    ...
    key: 'getSlice',
    value: function getSlice(id, callback) {
      var postBody = null;
      ...
      return this.apiClient.callApi('/slices/{id}', 'GET', pathParams, queryParams, headerParams, formParams, postBody, authNames, contentTypes, accepts, returnType, callback);
    }
    /**
    ...
    value: function runAnalysis(opts, callback) {
      ...
      var accepts = ['application/json'];
      var returnType = [_AnalysedSlice2.default];
